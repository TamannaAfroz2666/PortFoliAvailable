            ...
            <div className="showActivities">
                ...
                <div className="webDesign">
                    <div className="webContentsSingle">
                        ...
                        <p className='designDesSingle'>Several figmas such as consistency, colours, typography, imagery, simplicity, and functionality contribute to good website design.</p>
                    </div>
                    <div className="webImagesSingle">
                        <img src={figma1} alt="" />
                    </div>
